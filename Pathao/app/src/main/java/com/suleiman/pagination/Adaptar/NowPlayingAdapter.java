package com.suleiman.pagination.Adaptar;
...
public class NowPlayingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<MovieObject> movieResults;
    ...
    public void setMovies(List<MovieObject> movieResults) {
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View v1 = inflater.inflate(R.layout.item_list_nowplaying, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        MovieObject result = movieResults.get(position); // Movie
...
//                Do nothing
    ...
    */
    ...
    public void add(MovieObject r) {
        movieResults.add(r);
        notifyItemInserted(movieResults.size() - 1);
    }

    public void addAll(List<MovieObject> moveResults) {
        for (MovieObject result : moveResults) {
            add(result);
        }
    }

    public void remove(MovieObject r) {
    ...
    public void removeLoadingFooter() {
        ...
        MovieObject result = getItem(position);
